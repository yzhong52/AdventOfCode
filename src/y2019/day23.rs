...
use std::sync::Arc;
use std::thread;
use crate::y2019::AtomicIntCodeComputer::AtomicIntCodeComputer;
use crate::y2019::AtomicIntCodeComputer::AtomicIntCodeResult;
...
pub fn part1(input: Input<Vec<i128>>) -> Answer<usize> {
    ...
    for i in 0..CONTROLLER_COUNT {
        let controller = Arc::new(AtomicIntCodeComputer::new(input.data.clone()));
